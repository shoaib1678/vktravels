...
public class AesCryprUtil {
    ...
    public AesCryprUtil(String key){
        SecretKeySpec skey = new SecretKeySpec(getMD5(key), "AES");
        this.setupCrypto(skey);
    }
    
    public AesCryprUtil(String key,String type){
    	if(type.equalsIgnoreCase("teacher"))
    	{
        SecretKeySpec skey = new SecretKeySpec(getMD5("PSCOMA6w0UCxuyZ"), "AES");
        this.setupCrypto(skey);
    	}else 
    	{
    		SecretKeySpec skey = new SecretKeySpec(getMD5("PSCOMA6w0UCxuyZ"), "AES");
    ...
    */
    ...
    public static void main(String args[]){
		...
		if(err==null) {
			try {
				AesCryprUtil encrypter = new AesCryprUtil(key);
